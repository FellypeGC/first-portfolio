const translations = {
  en: {
    ...
    description1: "Landing page developed as a clone of the Reserva brand website, using HTML, CSS/SASS, and JavaScript. The project simulates sections such as product showcases, categories, and promotional highlights. Designed to replicate the visual and interactive experience of a men's fashion e-commerce site.",
  ...
  ptBr: {
    ...
    description1: "Landing page desenvolvida como clone do site da marca Reserva, utilizando HTML, CSS/SASS e JavaScript. O projeto simula seções como vitrines de produtos, categorias e destaques promocionais. Criado para reproduzir a experiência visual e interativa de um e-commerce de moda masculina.",
