...
const Home = () => {
  ...
  return (
    <section className="text-white flex justify-center items-center gap-12 min-h-screen p-6 md:py-20 md:flex-row md:px-20 max-w-7xl w-full mx-auto flex-wrap">
