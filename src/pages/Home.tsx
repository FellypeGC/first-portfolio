    ...
    <section className="text-white flex justify-center items-center gap-12 p-6 md:py-20 md:flex-row md:px-20 max-w-7xl w-full mx-auto flex-wrap">
      <div className="flex flex-col w-100 max-w-full md:w-120 md:h-100 gap-6">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight max-w-md">
          Software{" "}
          <span className="text-[rgb(37,106,244)] text-glow">Developer</span>
        </h1>
        <p className="md:text-md text-slate-400">
          Hello, World! I'm a Software Developer focused on turning ideas into reality by building reliable, scalable, and custom applications with AI-powered tools.
        </p>
